...
FilePicker get _platform => FilePicker.instance;

/// Allows you to mock the [LocationPlatform] instance for testing.
@visibleForTesting
void setLocationInstance(FilePicker platform) {
...
Future<bool?> clearTemporaryFiles() {
  return _platform.clearTemporaryFiles();
}
...
Future<String?> getDirectoryPath({
  ...
  return _platform.getDirectoryPath(
    dialogTitle: dialogTitle,
    lockParentWindow: lockParentWindow,
    initialDirectory: initialDirectory,
  );
